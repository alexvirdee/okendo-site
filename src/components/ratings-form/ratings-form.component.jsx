                    ...
                    <div className="range">
                      ...
                      <div className="c-numberRangeInput">
                        <input
                          ...
                          type="range"
                          className="u-assistive-hidden"
                          id="number-range-quality"
                          value="0"
                          step="1"
                          max="5"
                        />
                        ...
                        <div className="range-input-labels">
                          ...
                          <div className="range-input-labels-item">
                            Excellent
                          </div>
                        </div>
                      </div>
